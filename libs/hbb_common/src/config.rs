...
lazy_static::lazy_static! {
    ...
    pub static ref DEFAULT_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        // 替换下面这些占位符为你的实际服务器配置
        m.insert(keys::OPTION_CUSTOM_RENDEZVOUS_SERVER.to_string(), "8.153.105.121:21116".to_owned());
        m.insert(keys::OPTION_RELAY_SERVER.to_string(), "8.153.105.121:21117".to_owned());
        m.insert(keys::OPTION_API_SERVER.to_string(), "http://8.153.105.121:21114".to_owned());
        m.insert(keys::OPTION_KEY.to_string(), "lr8I43Tc0Qnsa1RIyJVkVxKwll1I2xxpPOco9HWcEa4=".to_owned());
        RwLock::new(m)
    };
